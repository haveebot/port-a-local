...
target_length: ~1,300 words
sources_floor: every claim sourced to a public record; no interviews
...
- City of Port Aransas City Council — Agenda Packet, January 17, 2019, p. 71 (cityofportaransas.org/wp-content/uploads/2020/01/Agenda-Packet-1-17-19.pdf)
- City of Port Aransas City Council — Eleven publicly-available 2019 agenda packets (full-text searched for variant phrasings of city-manager-routed deliberation material outside the public packet; verbatim phrase appears exactly once)
- City of Port Aransas City Council — Agenda, April 21, 2026 (cityofportaransas.civicweb.net) — Item 5 closed executive session naming the Palmilla Qualified Hotel Project and the proposed MOU and PSA
- City of Port Aransas City Council — Agenda, May 20, 2026 (cityofportaransas.civicweb.net) — Items 10.E (MMD consent resolution) and 10.F (working group authorization)
- City of Port Aransas — Texas Public Information Act response received May 6, 2026, from City Secretary Francisca Nixon
- *Port Aransas South Jetty* — April 30, 2026, *"Council advances conference center talks"*
- *Port Aransas South Jetty* — May 16, 2026, *"Port Aransas City Council to discuss proposed hotel conference center"*
- *Port Aransas South Jetty* — January 6, 2022, *"Public hearing on replat at Palmilla Beach PUD"* (KM Beach LLC as named applicant on 3900 Hwy 361)
- Texas Secretary of State — KM Beach, LLC corporate filing (registered address shared with McCombs Properties San Antonio headquarters; officers Marsha Shields, Harry Ben Adams IV, Steve L. Cummings; assumed-name certificates "Palmilla Beach Golf Club" and "Black Marlin Bar & Grill")
- McCombs Properties — Palmilla Beach Resort category page (mccombsproperties.com)
- Palmilla Beach Resort & Golf Community — Developer page (palmillabeach.com)

---

## Notes (not for publication)

**Word count target:** ~1,300 words. Current draft: ~1,180 words. Room to add 100-150 words for tonal smoothing if it reads choppy.

**Structural choices:**
- Title is the verbatim record-quote. Same phrase will be referenced (not repeated as title) in Part 2.
- Part 2 link/marker: the "subject of a forthcoming Dispatch" line in the close is the only explicit cross-reference. Readers who never see Part 2 still get a complete piece.
- The Charter Review / household network / Bureau composition / food-truck pattern / fix path are all explicitly held back. Their absence is intentional — Part 2 is where those land.
- The "exactly once across 2019" phrase finding is the records-discipline anchor of Part 1. In Part 2 the same finding becomes the lead-in to the "what the public packet does not contain" structural observation.

**What's named vs aggregate:**
- **Named:** City Manager David Parsons (paid public official). City Secretary Francisca Nixon (paid public official, by name in source citation only). KM Beach LLC officers Marsha Shields, Harry Ben Adams IV, Steve L. Cummings (corporate counterparty in a public-private deal — public Texas SOS record).
- **Not named:** Mayor, Council Members, Mayor Pro-Tem, P&Z Commissioners, Charter Review Commissioners, Tourism Bureau Board members, family members of any of the above. The "two members of the 2019 grading committee voted in favor of the 2026 MOU" finding lands without naming either.

**Pre-publish checklist:**
- Tuesday 5/19 morning publish target.
- File the two records requests on Wednesday 5/20 (after the vote) or Thursday 5/21 morning. Close commits to "after the May 20 vote" so timing is flexible within that window.
- Collie tonal read on the new lede + close once we agree the piece is structurally landed.
- Final confirm: nothing material has changed on the 5/20 agenda (no item withdrawn / no surprise added) on Monday 5/18.

**Open questions for Winston:**
- Title — verbatim record-quote is the working call.
- Series labeling visible to reader — "Part 1 of 2" subtitle, or quieter (just the kicker line in the close)?
- Length — 1,180 is on the low end; could expand the "Who is on the other side of the agreement" section with 1-2 more sentences of corporate-context if it reads thin.

**Open questions for Collie (held until structure is landed):**
- Visual treatment of the all-caps verbatim title.
- Pull-quote candidates: the seven-words quote, the 175 vs 182 numbers, the "exactly once" phrase finding, the "next set of decisions is on this Wednesday's agenda" close.

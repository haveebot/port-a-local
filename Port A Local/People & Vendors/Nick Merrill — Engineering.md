...
- Aware of the project but not actively involved in current build sessions

## Decision
Per [[Decision Log]] — operating model is Winston + Havee only. Speed and control over collaboration overhead. Nick can re-engage if/when it makes sense.

## Open Items
- [ ] Brief Nick on what's been built since going independent
- [ ] Discuss potential investor role if appropriate

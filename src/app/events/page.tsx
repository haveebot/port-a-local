...
const eventsByMonth: { month: string; events: PAEvent[] }[] = [
  ...
  },
  {
    month: "August",
    events: [
      { name: "Texas Legends Billfish Tournament", timing: "August 6–10, 2026 · weigh-ins Wed–Sat evenings", location: "Fisherman's Wharf, Port Aransas (HQ)", description: "$800K+ in prize money. The biggest billfish tournament in Port Aransas. One leg of the Texas Triple Crown. Run by Dee Wallace — TX Saltwater Fishing Hall of Fame, author of the billfish release verification protocol. Three species: blue marlin (weighed or released), white marlin and sailfish (release only).", icon: "🎣", detailSlug: "texas-legends-billfish-2026", nextDateISO: "2026-08-06" },

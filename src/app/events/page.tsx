...
const eventsByMonth: { month: string; events: PAEvent[] }[] = [
  ...
  },
  {
    ...
    events: [
      ...
      { name: "The Billfish Pachanga", timing: "July 15–18, 2026", location: "Virginia's on the Bay", description: "40-boat-cap, catch-and-release-only billfish tournament. Founded 2019 by Gabe Goodman out of Virginia's on the Bay. $845K record payout in 2024. Half the proceeds fund Harte Research Institute for Sportfish Science (TAMU-CC); other half funds the PA Scholarship Fund. The science-funding, restaurant-hosted edition of Tournament Season.", icon: "🐟", detailSlug: "billfish-pachanga-2026", nextDateISO: "2026-07-15" },
  ...
  },
  {
    month: "August",
    events: [
      { name: "Texas Legends Billfish Tournament", timing: "August 5–9, 2026 · fishing 5 PM Thu – 5 PM Sat", location: "Fisherman's Wharf, Port Aransas (HQ)", description: "$800K+ in prize money. The biggest billfish tournament in Port Aransas. One leg of the Texas Triple Crown. Run by Dee Wallace — TX Saltwater Fishing Hall of Fame, author of the billfish release verification protocol. Three species: blue marlin (weighed or released), white marlin and sailfish (release only).", icon: "🎣", detailSlug: "texas-legends-billfish-2026", nextDateISO: "2026-08-05" },
      { name: "Texas Women Anglers Tournament (TWAT)", timing: "August 21–23, 2026", location: "Fisherman's Wharf (weigh-in) · Reception venue downtown", description: "Women-only fishing tournament, family-run by Pete Fox's family since 1984. Dozens of boats, hundreds of women anglers each summer. Famous for the Saturday weigh-in spectacle — themed boats, costumes, money sprayers, beads thrown to the crowd. $130K+ raised for The Purple Door (Coastal Bend's shelter for survivors of domestic violence and sexual assault).", icon: "🎣", detailSlug: "texas-women-anglers-tournament-2026", nextDateISO: "2026-08-21" },
    ],
  },
  {
    month: "October",

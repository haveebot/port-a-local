...
export default function NotFound() {
  return (
    <main className="min-h-screen flex flex-col">
      ...
      {/* Hero — Gully (404 pose) on the left, right-aligned content on
          the right. Faint giant "404" watermark behind the right column.
          (2026-05-07 Collie Gully-character mock-up.) */}
      <section className="flex-1 hero-gradient relative flex items-center py-24 sm:py-32 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 w-full">
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-5 flex justify-center lg:justify-start">
              <Image
                src="/icons/gully-404.svg"
                alt="Gully looking lost"
                width={500}
                height={500}

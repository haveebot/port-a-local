...
export const dispatches: Dispatch[] = [
  ...
  },
  {
    ...
    subtitle:
      "Readers asked whether the ten-year record on State Highway 361 shows a day-and-night pattern. It does — a crash after dark on an unlit stretch is about four times as likely to kill as the same crash in daylight. Updated August 18 with the alcohol layer readers asked for next, including every fatal crash on the corridor since 2016 and why the public file undercounts impairment.",
    description:
      "A follow-up analysis of the TxDOT crash file for SH 361 between Port Aransas and Park Road 22, sorted by the light condition recorded on each crash report, then by impairment. Darkness is 27% of the corridor's crashes and half its fatal ones. Includes a record of every fatal crash on the corridor since 2016 with light condition and impairment from federal, court and lab sources — and evidence that the state crash file misses a third of the impaired fatal crashes.",
    category: "analysis",
    icon: "🌙",
    readTime: "8 min",
    featured: true,

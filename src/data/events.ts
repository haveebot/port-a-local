...
export const events: EventDetails[] = [
  ...
  {
    slug: "texas-sandfest-2027",
    name: "Texas SandFest 2027 — 30th Anniversary",
    tagline:
      "Three decades of impossibly intricate sand on Mustang Island. The Gulf Coast's biggest sand-sculpture festival hits its 30th year.",
    description:
      "Texas SandFest 2027 — the 30th anniversary edition of the largest native-sand sculpture competition in the United States. Three days of master sculptors, semi-pro and amateur brackets, the kids' corner, live music, sustainable-festival initiatives, and the same stretch of beach where Elleece Calvert and Sharon Schafer set up a card table in 1997 to watch their kids build sandcastles. Free to spectators. Mile Markers 13–17, Port Aransas Beach.",
    startISO: "2027-04-16T10:00:00-05:00",
    endISO: "2027-04-18T18:00:00-05:00",
    dateLabel: "April 16–18, 2027 (tentative — confirming with the SandFest board)",
    headlineTime: "Saturday, April 17 · master sculptors carving all day",
    venueName: "Port Aransas Beach (Mile Markers 13–17)",
    venueAddress: "Port Aransas Beach, Port Aransas, TX 78373",
    coordinates: [27.853, -97.0468],
    cost: "Free to spectators · GA + VIP wristbands available · Vendor + sponsor applications open",
    icon: "🏖️",
    featured: true,
    published: true,
    hostBusinessSlug: undefined,
    hostName: "Texas SandFest — 501(c)(3) volunteer-driven festival",
    tags: [
      "Texas SandFest",
      "SandFest",
      "sand sculpture",

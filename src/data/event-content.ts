...
export const eventContent: Record<string, EventContent> = {
  ...
  "texas-women-anglers-tournament-2026": {
    ...
    hostBlurb: [
      ...
      "PAL has a personal connection to the Fox family. We're covering this tournament because we want it covered better than anyone else — and because the cause behind the prize purse is one we'd cover even if there were no fish involved.",
    ],
    liveLog: [],
    hostTimeline: [
      {

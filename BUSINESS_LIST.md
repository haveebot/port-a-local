# Port A Local Co — Master Business List
_Working document. Build comprehensive first, curate later._
_🔑 = owner/affiliate (priority lead routing)_

## Category Rules
- Single word only — final nine: Eat, Drink, Stay, Do, Fish, Beach, Shop, Realty, Services
...
- Grumbles Seafood Co.
- Port A Pizzeria
- Lisabella's Bistro & Bar 🔑 (strong family relationship — priority listing)
...
- Island Surf Rentals
- Fly It! Port A
- Woody's Last Stand 🔑 (owner: Billy Gaskins — island legend, family friend — priority listing, multi-service waterfront hub)
...
## Services
- Port A Maintenance Services 🔑 (aka Midwest Woodworking — owner: John Brown, 361-455-8606 — primary maintenance/handyman affiliate, future portal routing target)
